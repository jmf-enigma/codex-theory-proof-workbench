...
- Rethlas/Archon pattern: separate informal strategy discovery from verification and formalization. Reuse fresh verifier context, append-only structured memory, and replayable artifacts, but do not copy fixed agent counts, unsafe execution flags, or the equation of verifier approval with kernel proof.
...
- Independent-route seeding lesson: early route scouts should share the theorem fence but not a favored sketch. Classify their outputs by mathematical mechanism, redirect saturated families, and cross-pollinate only after each live family exposes a concrete artifact or exact gap.
...
7. Multi-agent dispatch gate: if the user asked for parallel agents, write role briefs before delegation. Treat roles as a menu, not a fixed roster; allocate only the roles that can produce the current highest-value missing artifacts. For open-ended route discovery, independent scouts may each return one route card; hide the current favorite and other scouts' narratives until the seed pass ends. Do not spawn two agents to write competing full proofs of the same route.
8. Integrator checkpoint: after agents return, group route cards by mathematical approach family before ranking them. Merge artifacts by proof-state delta, not by eloquence; choose one leading and one incompatible shadow family, redirect saturated families, and preserve underexplored ones. Prefer counterexamples, verified lemmas, hidden assumptions, retrieved theorem patterns, and concrete gap reports over long prose.
...
- Treat workflow changes as hypotheses too. Smoke tests check plumbing; improvement claims require held-out, version-pinned, realistic proof obligations and final-assembly success.
...
- **Retrieval, strategy growth, and local repair**: LeanDojo/ReProver, [LeanSearch v2](https://arxiv.org/abs/2605.13137), [Lean Finder](https://arxiv.org/abs/2510.15940), [Prover Agent](https://arxiv.org/abs/2506.19923), [OProver](https://arxiv.org/abs/2605.17283), APOLLO, [APRIL](https://arxiv.org/abs/2602.02990), [TacMiner](https://arxiv.org/abs/2503.24036), and [proof-strategy extraction](https://arxiv.org/abs/2510.10131) motivate intent-aware premise search, diagnostic-grounded repair, bottom-up auxiliary lemmas, and dependency-based strategy promotion.
- **Discovery and route search**: [Discover and Prove](https://arxiv.org/abs/2604.15839), [AlphaEvolve](https://arxiv.org/abs/2506.13131), [PatternBoost](https://arxiv.org/abs/2411.00566), [AI-assisted open-problem discovery](https://arxiv.org/abs/2603.04735), [$k$-server-bench](https://arxiv.org/abs/2604.07240), [self-supervised theorem discovery](https://arxiv.org/abs/2606.28747), [MLEvolve](https://arxiv.org/abs/2606.06473), [AlphaProof Nexus](https://arxiv.org/abs/2605.22763), and [Aristotle](https://arxiv.org/abs/2510.01346) motivate discover-then-prove handoff, one-sided executable evaluators, diverse populations, cross-branch memory, theorem extraction, and state deduplication.
...
- **Correction and verification**: [Goedel-Prover-V2](https://arxiv.org/abs/2508.03613), [process-verified theorem proving](https://arxiv.org/abs/2606.20068), [Aletheia](https://arxiv.org/abs/2602.10177), [QEDBench](https://arxiv.org/abs/2602.20629), [axiom-audited Lean](https://openreview.net/forum?id=adCv2IV5V3), and Prover-Verifier Games motivate first-error feedback, verifier-bias controls, explicit trust footprints, independent checking, abstention, and final assembly audits.
...
- **Workflow evaluation**: [SorryDB](https://arxiv.org/abs/2603.02668) and [self-modifying Lean agents](https://arxiv.org/abs/2607.17352) motivate pinned real-project tasks, held-out evaluation, mastery-triggered curriculum hardening, a fixed trusted verifier, and the warning that richer decomposition is not progress when assembly success falls.
